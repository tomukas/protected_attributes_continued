...
Gem::Specification.new do |gem|
  ...
  gem.add_dependency "activemodel",  ">= 5.0", "< 8"

  gem.add_development_dependency "activerecord", ">= 5.0", "< 8"
  gem.add_development_dependency "actionpack",   ">= 5.0", "< 8"
  gem.add_development_dependency "railties",   ">= 5.0", "< 8"
